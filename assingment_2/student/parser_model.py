...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        # Получаем эмбеддинги для всех индексов в w
        x = self.embeddings[w]  # shape: (batch_size, n_features, embed_size)

        # Преобразуем в (batch_size, n_features * embed_size)
    ...
    def forward(self, w):
        ...
        # 4) Second linear layer (to logits)
